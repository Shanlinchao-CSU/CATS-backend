...
public class RedisStreamConsumerConfig {
     ...
     */
    @Bean
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> consumerListener2(
            RedisConnectionFactory connectionFactory,
            OrderStreamListener streamListener) {
        StreamMessageListenerContainer<String, ObjectRecord<String, String>> container =
     ...
     */
    @Bean
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> consumer2Listener2(
            RedisConnectionFactory connectionFactory,
            OrderStreamListener streamListener) {
        StreamMessageListenerContainer<String, ObjectRecord<String, String>> container =
                stream2Container(redisStreamConfig.getStream2(), connectionFactory, streamListener);
        container.start();
        return container;
    }

    /**
     * 主要做的是将OrderStreamListener监听绑定消费者，用于接收消息 Del
     *
     * @param connectionFactory 连接工厂
     * @param streamListener    消费者监听器
     * @return StreamMessageListenerContainer
     */
    @Bean
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> consumerDelListener(
            RedisConnectionFactory connectionFactory,
            OrderStreamListener streamListener) {
        StreamMessageListenerContainer<String, ObjectRecord<String, String>> container =
                streamContainerDel(redisStreamConfig.getStream(), connectionFactory, streamListener);
        container.start();
        return container;
    }
     ...
     */
    @Bean
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> consumer2DelListener(
            RedisConnectionFactory connectionFactory,
            OrderStreamListener streamListener) {
        StreamMessageListenerContainer<String, ObjectRecord<String, String>> container =
                streamContainerDel(redisStreamConfig.getStream2(), connectionFactory, streamListener);
        container.start();
        return container;
    }
     ...
     * @return StreamMessageListenerContainer
     */
    private StreamMessageListenerContainer<String, ObjectRecord<String, String>> stream2Container(
            String mystream,
            RedisConnectionFactory connectionFactory,
            StreamListener<String, ObjectRecord<String, String>> streamListener) {
        ...
        StreamOffset<String> offset = StreamOffset.create(mystream, ReadOffset.lastConsumed());
        //创建消费者
        Consumer consumer = Consumer.from(redisStreamConfig.getGroup(), redisStreamConfig.getConsumer2());
        StreamMessageListenerContainer.StreamReadRequest<String> streamReadRequest =
                StreamMessageListenerContainer.StreamReadRequest
                        .builder(offset)
                        .errorHandler((error) -> {
     ...
     * @return StreamMessageListenerContainer
     */
    private StreamMessageListenerContainer<String, ObjectRecord<String, String>> streamContainerDel(
            String mystream,
            RedisConnectionFactory connectionFactory,
            StreamListener<String, ObjectRecord<String, String>> streamListener) {
        ...
        //创建消费者
        Consumer consumer = Consumer.from(redisStreamConfig.getGroup(), redisStreamConfig.getDel());
        StreamMessageListenerContainer.StreamReadRequest<String> streamReadRequest =
                StreamMessageListenerContainer.StreamReadRequest
                        .builder(offset)
                        .errorHandler((error) -> {
